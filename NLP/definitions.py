...
PLOT_TIME_SVM_FILE = BASE_DIR + "/NLP/Plots/svm_file_1.txt"
PLOT_TIME_SGD_FILE = BASE_DIR + "/NLP/Plots/sgd_file_1.txt"
...
PLOT_NAIVE_BAYES = BASE_DIR + "/NLP/Plots/naive_bayes_whole_dataset.txt"
